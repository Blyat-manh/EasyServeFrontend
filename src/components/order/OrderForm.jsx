  ...
  return (
    <div className='oreder-form'>
      ...
      <select
        id="table-select"
        value={selectedTable}
        onChange={(e) => setSelectedTable(Number(e.target.value))} // <-- Cambiado: asegura tipo number
      >
        <option value="">Selecciona una mesa</option>
        {availableTables
          .filter((table) => table.status !== "reserved") // <-- Solo mesas no reservadas
          .map((table) => (
